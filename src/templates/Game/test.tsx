...
describe('<Game />', () => {
  ...
  it('should not render the gallery on mobile', () => {
    ...
    expect(screen.getByTestId('Mock Gallery').parentElement?.parentElement).toHaveStyle({
      display: 'none'
    })

    expect(screen.getByTestId('Mock Gallery').parentElement?.parentElement).toHaveStyleRule(
      'display',
      'block',
      {
